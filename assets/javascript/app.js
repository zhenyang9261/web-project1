        ...
        $.ajax({
            ...
            response.forEach(function (recipe) {
                ...
                $.ajax({
                    ...
                    $("#recipe-div").append(" <div class='col s12 m7 l4'> <div class='card'> <div class='card-image'> <img src='" + recipe.image + "'><span class='shadow-text card-title'>" + recipe.title + "</span> </div> <div class='card-content text-size'> <p>" + summaryObj.summary + "</p> </div> <div class='card-action text-size' data-id=" + recipe.id + "> <a href='#'>Make This!</a> </div> </div> </div>");
                });
