        ...
        $.ajax({
            ...
            // response.forEach(function (recipe) {
                $.ajax({
                    ...
                    url: "https://api.spoonacular.com/recipes/" + recipe[i].id + "/summary?apiKey=88df5afa7d444635ad16e4505c402a69",
                    method: "GET"
                    ...
                    fab.attr('data-summary', summary[i].summary);
